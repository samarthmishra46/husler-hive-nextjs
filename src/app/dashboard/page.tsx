  ...
  return (
    <div className="landing-section" style={{ minHeight: '80vh', paddingTop: '100px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        {/* Warning banner for role assignment failure */}
        {warning === 'role_failed' && (
          <div style={{ marginBottom: '32px', background: 'rgba(245,158,11,0.08)', border: '1px solid rgba(245,158,11,0.2)', borderRadius: '16px', padding: '20px 24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(245,158,11,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              ...
              <div>
                <h3 style={{ fontWeight: 700, color: '#f59e0b', fontSize: '0.95rem' }}>Discord Role Issue</h3>
                <p style={{ fontSize: '0.82rem', color: '#fcd34d', marginTop: '2px' }}>
                  We couldn&apos;t add you to the signals channel. Please contact support or try reconnecting Discord.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Success banner */}
        {discordStatus === 'connected' && !warning && (
